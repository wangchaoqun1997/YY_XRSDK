...
namespace YYSX
{
    ...
    /// </summary>
    //[XRCustomLoaderUI("YYSX.YYSXLoader", BuildTargetGroup.Standalone)]
    public class YYSXStandaloneLoaderUI : IXRCustomLoaderUI
    {
        ...
        struct Content
        {
            public static readonly GUIContent k_LoaderName = new GUIContent("YYSX Loader One Custom <SAMPLE ONLY YOU MUST REIMPLEMENT>");
