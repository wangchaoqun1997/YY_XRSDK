...
namespace YYSX
{
    ...
    /// </summary>
    public class YYSXBuildProcessor : IPreprocessBuildWithReport, IPostprocessBuildWithReport
    {
        ...
        void CleanOldSettings()
        {
            ...
            var oldSettings = from s in preloadedAssets
                where s != null && s.GetType() == typeof(YYSXSettings)
                select s;
        ...
        public void OnPreprocessBuild(BuildReport report)
        {
            ...
            EditorBuildSettings.TryGetConfigObject(YYSXConstants.k_SettingsKey, out settings);
            if (settings == null)
                return;
